...
import 'package:infocom_task/views/dogImages.dart';
import 'package:infocom_task/views/profileScreen.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  var platform = const MethodChannel('bluetooth_channel');

  void enableBluetooth() async {
    try {
      final bool isEnabled = await platform.invokeMethod('enableBluetooth');
      print("Bluetooth is turned ${isEnabled ? 'on' : 'off'}");
            ...
            Padding(
             padding: EdgeInsets.symmetric(vertical: 10),
              child: ElevatedButton(
                onPressed: () {
                  GlobalFunction.navigateTo(context, DogImagesScreen());
                },
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text('* Please allow nearby devices permission in app info')
                ],
              ),
            ),
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  GlobalFunction.navigateTo(context, ProfileScreen());
                },
                child: Padding(
